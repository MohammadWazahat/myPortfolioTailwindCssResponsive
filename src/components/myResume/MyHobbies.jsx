      ...
      <div className="flex justify-center items-center m-4 gap-6 ">
        ...
        >
          <div className="">
            <img
              className="w-80 h-48"
              src="https://images.pexels.com/photos/290660/pexels-photo-290660.jpeg?auto=compress&cs=tinysrgb&w=600"
              alt=""
            />
          </div>
          <div className="text-2xl font-normal hover:text-green-500">Music</div>
        </div>
